...
class Action:
    ...
    # The measurement context this study is run in. The per-(h, ctx) systematic
    # bias keys on (hypothesis_id, context_id), so two studies sharing a context
    # share the same bias; studies in different contexts get independent biases.
